...
export default ({event}) => {
  ...
  const location = place ? place.location : null
  let gmapsQuery = null
            ...
            <div className="Event-content">
              ...
              <div className="Event-meta">
                <div className="Event-date">
                  <svg className="icon-calendar" viewBox="0 0 416 448" aria-hidden="true">
            ...
            <section className="Event-lineup">
              ...
              <ul>
                {lineup.map(performer => (
                  <li key={performer.id}>
                    <PerformerMinicard performer={performer} />
                  </li>))}
              </ul>
            </section>}
        </div>
